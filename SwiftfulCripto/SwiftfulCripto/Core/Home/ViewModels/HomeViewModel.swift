...
class HomeViewModel: ObservableObject {
    ...
    func addSubscribers() {
        ...
        $allCoins
            ...
            .sink { [weak self] (returnedCoins) in
                ...
                self.portifolioCoins = sortPortfolioCoinsIfNeeded(coins: returnedCoins)
            }
            .store(in: &cancellables)
    ...
    private func mapAllCoinsToPortfolioCoin(
        allCoins: [CoinModel], portfolioEntities: [PortfolioEntity]
    ) -> [CoinModel] {
        allCoins
